...
<template>
  <section class="flex flex-col items-center justify-center mt-8">
    <div class="chatbot-container bg-gray-800 text-white rounded-lg shadow-lg p-4 w-3/4">
      <h2 class="text-neutral-200 text-xl font-bold mb-4 text-center font-sans flex items-center justify-center">
        <img class="rounded-full w-10 mr-3 shadow-sm" src="../../../shared/assets/assistant.webp" alt="Isaac assistant">
        Isaac's Assistant
      </h2>
      <div class="chat-messages max-h-100 overflow-y-auto border rounded p-4 bg-gray-800 space-y-4">
        <div
        ...
        >
            <div class="mb-2">
            <div class="bg-blue-500 text-white p-3 rounded-lg text-sm w-full">
                <p class="font-semibold">User:</p>
                <p>{{ context.inputText }}</p>
            </div>
            </div>
            <div class="mb-2">
            <div class="bg-gray-700 text-white p-3 rounded-lg text-sm w-full">
      ...
      <section class="flex flex-row w-full justify-center">
        <div class="input-container flex mt-6 w-10/12">
          <input
            v-model="userInput"
            type="text"
            placeholder="Ask me anything about The Binding of Isaac..."
            class="flex-grow p-2 rounded-l-lg border-0 text-gray-800"
